...
!     real(MK),parameter :: PRECISION_UI  = 2.2204460e-10_MK  !< 
    ...
    !--------------------------------------------------------------------------------
    !--- Specific to omnivor, wtlib and hawc
    !--------------------------------------------------------------------------------
    ! Omnivor 
    integer, parameter :: UK = MK       !< Induved Velocity Kind, has to be C compatible (NOT USED FOR NOW)
    integer, parameter :: AK = 8        !< Matrix Solving Kind (4 or 8 for lapack)
    ! Hawc
    integer, parameter :: R8 = 8
    integer, parameter :: R4 = 4
    ! Profiles
    integer, parameter :: PROFILE_POLAR_KIND = R4 ! for hawc
contains
